              ...
              {authTab === 'login' ? (
                ...
                <form
                  onSubmit={async (e) => {
                    ...
                    try {
                      // Prepare customer data (without id - will be generated by database)
                      const newCustomerData = {
                        umkmPresetId: currentPreset.id, // ✅ Use umkmPresetId to match backend
                        userId: allCustomers.length > 0 ? Math.max(...allCustomers.map(c => c.userId)) + 1 : 205,
                        name: registerName,
                        email: registerEmail,
                        phone: registerPhone,
                      ...
                      console.log('📤 Saving customer to database:', newCustomerData);
                      ...
                      alert(`🎉 Akun Pembeli baru "${savedCustomer.name}" berhasil diregistrasi dan tersimpan di database! Silakan lanjutkan menuju Checkout.`);
